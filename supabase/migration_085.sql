...
--
-- order_id was NOT NULL which prevented inserting standalone testimonials.
-- These seeded reviews are not linked to real orders, so order_id is NULL.
...
SELECT NULL, 'BBJ-1024', 'Mina L.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1041', 'Sophia T.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1057', 'Michelle A.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1073', 'Linh N.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1086', 'Grace W.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1098', 'Alyssa R.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1109', 'Annie N.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1126', 'Vanessa C.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1164', 'Jenny P.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1187', 'Thao H.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1199', 'Rachel D.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1208', 'Emily K.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1211', 'Tina V.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1236', 'Candice M.', 10,
       'From the beginning to the end of the process, ordering my Monet jade bangle was a smooth and enjoyable experience. The seller was very communicative throughout every stage, from sourcing the raw material to the finished product, and provided lots of updates and photos along the way which made me feel very confident in my purchase. I''m extremely happy with both the customer service and the bangle itself. The piece is beautiful, unique, and very high quality with an excellent polish and a beautiful colour combination. I am especially glad I went with a raw material purchase as that allowed it to be made in my ideal size and shape, which can be difficult to find. You can really tell care and attention went into the entire process, even at the end with the beautiful packaging. I''ve already started looking at other pieces from BingBing Jade and would definitely purchase again.',
       '2026-04-08', '2026-04-10', true
WHERE NOT EXISTS (SELECT 1 FROM public.reviews WHERE order_number = 'BBJ-1236');

INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1252', 'Melissa C.', 10,
...
INSERT INTO public.reviews (order_id, order_number, customer_name, rating, description, date_purchased, date_rated, is_approved)
SELECT NULL, 'BBJ-1256', 'Gracie W.', 10,
