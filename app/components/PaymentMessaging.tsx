...
function AffirmLogo() {
  return (
    <svg
      ...
      aria-label="Affirm"
      className="h-4 w-auto shrink-0 self-end text-gray-900 dark:text-white"
    >
...
function AfterpayLogo() {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      aria-label="Afterpay"
      className="h-4 w-auto shrink-0 self-end"
    >
...
export function PaymentMessaging({
  ...
  return (
    <div className={`flex items-center gap-1.5 whitespace-nowrap ${className ?? ""}`}>
      <span className="text-[11px] sm:text-xs text-gray-400 dark:text-gray-500">From</span>
      {amount}
      <span className="text-[11px] sm:text-xs text-gray-400 dark:text-gray-500">with</span>
      {info.showAfterpay && (
        <>
          <AfterpayLogo />
      ...
      <AffirmLogo />
      <span className="text-[11px] sm:text-xs text-gray-400 dark:text-gray-500">· See if you qualify</span>
    </div>
  );
}
